...
public class ThematicQuotesTest extends ThematicQuotesPage {
    ...
    @Test
    @DisplayName(value = "Тест-кейс 37. Отображение max кол-во цитат в разделе")
    ...
    @Test
    @DisplayName(value = "Тест-кейс 38. Просмотр описания цитаты")
