...
public class AboutApplicationTest extends AboutApplicationPage {
    ...
    @Test
    @DisplayName(value = "ТС-005. Переход по ссылке Пользовательское соглашение")
    ...
    @Test
    @DisplayName(value = "ТС 048. Отображение текущей версии приложения на странице")
    ...
    @Test
    @DisplayName(value = "ТС-014. Переход по ссылке Политика Конфиденциальности")
    @io.qameta.allure.kotlin.Description(value = "Тест проверяет интент")
