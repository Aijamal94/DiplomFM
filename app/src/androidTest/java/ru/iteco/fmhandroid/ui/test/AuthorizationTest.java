...
public class AuthorizationTest extends AuthorizationPage {
    ...
    @Test
    @DisplayName("ТС-049. Авторизация с валидными значениями полей логин и пароль")
    ...
    @Test
    @DisplayName("ТС-050. Авторизация с пустыми полями")
    ...
    @Test
    @DisplayName("ТС-051. Авторизация с валидным паролем и логином содержащим ошибку")
